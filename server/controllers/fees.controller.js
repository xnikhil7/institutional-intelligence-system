...
exports.createFeesTemplate = async (req,res)=>{
 try{
   ...
   const templateId = result.id || result.insertId;
   res.status(201).json({msg:"Template saved successfully", data: {id: templateId, branch: cleanBranch, year: cleanYear, caste: cleanCaste, t, d, e, o, total}});
